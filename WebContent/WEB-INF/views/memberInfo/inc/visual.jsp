...
<ul class="nav nav-tabs">
	<li id="memberBoard"><a href="memberBoard.go?mno=1">게시물</a></li>
	<li id="memberStatement"><a href="memberStatement.go?mno=2">진술서</a></li>
	<li id="memberStatement2"><a href="memberStatement2.go?mno=3">진술서2</a></li>
