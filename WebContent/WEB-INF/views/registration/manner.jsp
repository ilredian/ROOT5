...
<div class="container">
	...
	<div class="container" align="center">
		<table class="table">
			...
			<tr>
				<th class="active"><label for="s_stie">사이트명(URL)</label> <code>*</code></th>
			...
			<tr>
				<th class="active">거래 물품 종류 <code>*</code></th>
				<td>
					<table>
						<ul class="damageGoodsDealList">
							<tr>
								...
								<td align="center"><il class="oneLine"> <input
										...
										value="티켓/상품권" onclick="label_rdo_click('s_goods1');">
									<label for="s_goods1"><h1>
							...
							<tr>
								...
								<td align="center"><il class="first "> <input
										...
										value="소프트웨어" onclick="label_rdo_click('s_goods20');">
									<label for="s_goods20"><h1>
			...
			<tr>
				<th class="active"><label for="s_id">물품명<code>*</code></th>
	...
	<div class="formSection">
		...
		<table class="table">
			...
			<tr>
				<th class="active">계좌정보 <code>*</code></th>
			...
			<tr id="show_bank_info_1">
				<th class="active"><label for="su_bank">은행명</label> <code>*</code></th>
			...
			<tr id="show_bank_info_2">
				<th class="active"><label for="su_name">명의자 성명</label> <code>*</code></th>
			...
			<tr id="show_bank_info_3">
				<th class="active"><label for="su_bankNum">계좌 번호</label>
				<code>*</code></th>
			...
			<tr id="show_bank_info_4">
				<th class="active"><label for="su_sum">입금 금액</label>
				<code>*</code></th>
			...
			<tr id="show_bank_info_5">
				<th class="active"><label for="su_dateY">입금일</label>
				<code>*</code></th>
			...
			<tr>
				<th class="active">연락처 정보 <code>*</code></th>
			...
			<tr id="show_tel_info">
				<th class="active"><label for="su_tel">연락처</label>
				<code>*</code></th>
	...
	<div class="container">
		<div class="container">
			...
			<table class="table">
				...
				<tr>
					<th class="active"><label for="vi_pw">피해사례 비밀번호</label>
					<code>*</code></th>
				...
				<tr>
					<th class="active"><label for="vi_name">성명</label>
					<code>*</code></th>
				...
				<tr>
					<th class="active"><label for="vi_tel">연락처</label>
					<code>*</code></th>
				...
				<tr>
					<th class="active"><label for="vi_email">이메일</label>
					<code>*</code></th>
