...
<div class="container" align="center">
	<div class="formSection">
		...
		<table class="table-condensed" border="1px" width="850px">
			<colgroup>
				<col width="150">
				<col width="*">
			</colgroup>
			<tbody>
						...
						<ul class="damageGoodsDealList" style="float: left;">
							...
							<div class="l" style="float: left; text-align: center;">
								<input type="radio" name="cheat_item_temp" class="rdo"
									...
									onclick="label_rdo_click('s_goods13');"> <label
									for="s_goods13"> <img src="images/19.PNG"
									title="성인/사행성" onclick="label_rdo_click('s_goods13');">
							...
							<div class="l" style="float: left; text-align: center;">
								<input type="radio" name="cheat_item_temp" class="rdo"
									...
									onclick="label_rdo_click('s_goods13');"> <label
									for="s_goods13"> <img src="images/8.PNG"
									title="안경/선글라스" onclick="label_rdo_click('s_goods13');">
							...
							<div class="l" style="float: left; text-align: center;">
								<input type="radio" name="cheat_item_temp" class="rdo"
									...
									onclick="label_rdo_click('s_goods13');"> <label
									for="s_goods13"> <img src="images/guitar.PNG"
									title="기타" onclick="label_rdo_click('s_goods13');">
				...
				<tr>
					...
					<td><input type="text" class="txt" name="subject" id="s_id"
						value placeholder="거래한 물품의 물품명 또는 모델명을 입력하세요"
		...
		<table class="table-condensed" border="1px">
			...
			<tr>
				...
				<td><select name="member_phone1" id="vi_tel" title="국번선택"
					...
					<a onclick="v2014_handphone_check('#member_phone');return false;"
					target="target_iframe"><img src="images/injung.PNG"
						alt="인증번호 받기 (무료)"></a>
					<div style="padding-top: 5px;">
						<label>※ SMS가 수신되지 않는 경우, 스팸 문자함을 확인해 보세요. <br>※ 스팸
							차단 앱을 설치한 경우에는 해당 앱의 스팸함을 확인해 보세요.
						</label>
