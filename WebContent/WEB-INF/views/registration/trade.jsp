	...
	<div class="container">
		...
		<h3>피해 발생 사이트 정보</h3>
			<div class="container" align="center">
				<table class="table">
					<tr>
							<th class="active" style="width:150;"><label for="s_stie">사이트명(URL)</label> <span
						...
						<tr>
							<th class="active" style="width:150;">거래 물품 종류 <span class="bltS_A">*</span></th>
							<td>
						...
						<tr>
							<th class="active" style="width:150;"><label for="s_id">물품명</label><span class="bltS_A">*</span></th>
						...
						<tr>
							<th class="active" style="width:150;"><label for="s_id">용의자 아이디</label></th>
							<td><input type="text" class="txt" name="cheat_id" id="cheat_id"
								value="" placeholder="사기범의 ID 또는 메신져주소, 이메일주소 등을 입력하세요."
								style="width: 580px;" maxlength="20"></td>
						</tr>

						<tr>
							<th class="active" style="width:150;"><label for="s_link">사기 게시물 링크</label></th>
							<td><input type="text" class="txt" name="link"
								id="link" value="" placeholder="판매 게시물의 URL을 입력하세요."
								style="width: 580px;" maxlength="400"></td>
						</tr>
				</table>
			</div>
			...
			<div class="container" align="center"> 
				<table class="table">
							...
							<tr>
								<th class="active" style="width:150;">계좌정보 <span class="bltS_A">*</span></th>
							...
							<tr id="show_bank_info_1">
								<th class="active" style="width:150;"><label for="su_bank">은행명</label> <span class="bltS_A">*</span></th>
							...
							<tr id="show_bank_info_2">
								<th class="active" style="width:150;"><label for="su_name">명의자 성명</label> <span
									class="bltS_A">*</span></th>
							...
							<tr id="show_bank_info_3">
								<th class="active" style="width:150;"><label for="su_bankNum">계좌 번호</label> <span
									class="bltS_A">*</span></th>
							...
							<tr id="show_bank_info_4">
								<th class="active" style="width:150;"><label for="su_sum">입금 금액</label> <span class="bltS_A">*</span></th>
							...
							<tr id="show_bank_info_5">
								<th class="active" style="width:150;"><label for="su_dateY">입금일</label> <span class="bltS_A">*</span></th>
							...
							<tr>
								<th class="active" style="width:150;">연락처 정보 <span class="bltS_A">*</span></th>
							...
							<tr id="show_tel_info">
								<th class="active" style="width:150;"><label for="su_tel">연락처</label> <span class="bltS_A">*</span></th>
								<td><select name="cheat_phone1" id="su_tel" title="국번선택"
									...
									style="ime-mode: disabled;"
									onKeyPress="return numbersonly(event, false)"
									style="width:70px;" title="끝 자리 입력" />&nbsp;<input
									type="hidden" name="cheat_phone" value="" readonly /> ※ 050
									임시번호 등록을 금합니다.</td>
							</tr>
							...
							<tr>
								...
								<td><span class="chkArea"><input type="radio"
										...
										type="radio" name="cheat_sex" value="2" id="su_sexW"
										class="rdo"><label for="su_sexW">여자</label></span></td>
							</tr>

							<tr>
								<th class="active" style="width:150;"><label for="su_keynote">용의자 특징</label></th>
				...
				<div class="container" align="center">
						...
						<table class="table">
							...
							<tr>
								<th class="active" style="width:150;"><label for="vi_pw">피해사례 비밀번호</label> <span
									class="bltS_A">*</span></th>
							...
							<tr>
								<th class="active" style="width:150;"><label for="vi_name">성명</label> <span class="bltS_A">*</span></th>
								<td><input type="text" class="txt" name="name" value=""
									id="vi_name" style="width: 230px;" placeholder="귀하의 성명을 입력하세요."></td>
							</tr>

							<tr>
								<th class="active" style="width:150;"><label for="vi_tel">연락처</label> <span class="bltS_A">*</span></th>
							...
							<tr>
								<th class="active" style="width:150;"><label for="vi_email">이메일</label> <span class="bltS_A">*</span></th>
...
③ 제품에 대한 상태불만, 반품거부, 택배비 착불등의 사례 등록은 영업방해 및 명예훼손에 해당될 수 있습니다.
						...
						<div class="alert_cheat_write alert_cheat_write-info">
							<b><input type="checkbox" name="agreement_1" value="1"
								...
								href="NewFile.html" target="_blank"
								class="alert_cheat_write-link"> :: 약관 보기</a>
						</div>
						<div class="alert_cheat_write alert_cheat_write-info">
...
보존 기간 : 3개월
					...
					<!-- <div id="submit_btn" class="submit_btn">
						<a href="statementMain.go?cno=1"><img
							src="registrationimages/trade/agrbut.PNG" alt=""></a>
						

					</div> -->
					<!-- <input type="submit" value="" name="" onclick="return confirm('확인 버튼을 누른 후 피해사례가 등록될 때 까지 기다려 주세요.');"/> -->
					<input type="submit" value="" name="" onclick="return formOK('확인 버튼을 누른 후 피해사례가 등록될 때 까지 기다려 주세요.');"/>
					</div>
				</table>
			</div>
		</div>
