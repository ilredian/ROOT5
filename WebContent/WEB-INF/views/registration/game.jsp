		...
		<tr>
			...
			<td>
				<ul class="damageGoodsDealList">
					<il class="first oneLine" style="float: left;">
					<input type="radio" name="cheat_item_temp" class="rdo"
						id="s_goods17" value="포인트/마일리지"
						onclick="label_rdo_click('s_goods17');">
					<label for="s_goods17" style="margin-right: 10px"><img
						src="img/mon.PNG" title="포인트/마일리지"
						onclick="label_rdo_click('s_goods17');">
						<div class="sub_msg">포인트/마일리지</div></label></il>


					<il class="oneLine" style="float: left;">
					<input type="radio" name="cheat_item_temp" class="rdo"
						id="s_goods18" value="게임 아이템"
						onclick="label_rdo_click('s_goods18');">
					<label for="s_goods18" style="margin-top: 8px; margin-right: 10px"><img
						src="img/item.PNG" title="게임 아이템"
						onclick="label_rdo_click('s_goods18');">
						<div class="sub_msg">게임 아이템</div></label></il>


					<il class="oneLine" style="float: left;">
					<input type="radio" name="cheat_item_temp" class="rdo"
						id="s_goods20" value="아이디/계정"
						onclick="label_rdo_click('s_goods20');">
					<label for="s_goods20" style="margin-top: 8px"><img
						src="img/ID.PNG" title="아이디/계정"
						onclick="label_rdo_click('s_goods20');">
...
③ 제품에 대한 상태불만, 반품거부, 택배비 착불등의 사례 등록은 영업방해 및 명예훼손에 해당될 수 있습니다.
        ...
        <div class="alert_cheat_write alert_cheat_write-info">
            <b><input type="checkbox" name="cheat_rule_c" value="1" id="cheat_rule_c"  valign="bottom" onclick="return cheat_rule_check(cheat_rule.value)"/> <label for="cheat_rule_c">피해사례 등록 약관에 동의합니다.(필수)</label></b>
            <input type="hidden" readonly name="cheat_rule" value="" valign="bottom" style="width:0px;height:0px;">
        </div>
