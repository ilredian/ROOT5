...
<div class="container">
	게임 피해 사례 수 : <c:out value="${boardCount}"></c:out>
			...
			<c:forEach var="list" items="${list}">
				<tr>
					...
					<td><input type="button" class="btn btn-info viewBtn" value="자세히보기"
						id="statementView.go?sno=${list.stateno}&cno=2"></td>
...
<div>
	<a href="game.go"><input type="button" class="btn btn-info" id="a" style="float: right;" value="사기피해사례 등록"></a>
</div>
